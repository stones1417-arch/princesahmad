"""Preserved role-model draft; not imported by Django at runtime."""
...
class Role(models.Model):
    ...
    كل دور مرتبط بمجموعة Django Group، وبذلك يستطيع Django
    التحقق من الصلاحيات باستخدام user.has_perm مباشرة.
    """
    ...
    code = models.SlugField(
        ...
        help_text=(
            "رمز تقني ثابت، مثل: system_admin أو shift_supervisor"
        ),
    )
    ...
    is_system_role = models.BooleanField(
        ...
        help_text="الدور النظامي يتم إنشاؤه وإدارته بواسطة المنصة.",
    )
    ...
    def permissions(self):
        """
        صلاحيات الدور من مجموعة Django المرتبطة به.
        """
    ...
    def save(self, *args, **kwargs):
        ...
        with transaction.atomic():
            ...
            if (
                ...
                previous_role = Role.objects.filter(
                    pk=previous_role_id
                ).first()
